...
GLM_FUNC_QUALIFIER genIUType nextPowerOfTwo(genIUType value) {
    ...
    return detail::compute_ceilPowerOfTwo<1, genIUType, defaultp, std::numeric_limits<genIUType>::is_signed>::call(
            vec<1, genIUType, defaultp>(value)).x;
}
...
GLM_FUNC_QUALIFIER genIUType prevPowerOfTwo(genIUType value) {
    ...
    return isPowerOfTwo(value) ? value : static_cast<genIUType>(static_cast<genIUType>(1)
            << static_cast<genIUType>(findMSB(value)));
}
...
GLM_FUNC_QUALIFIER genIUType nextMultiple(genIUType Source, genIUType Multiple) {
    ...
    return detail::compute_ceilMultiple<std::numeric_limits<genIUType>::is_iec559, std::numeric_limits<genIUType>::is_signed>::call(
            Source, Multiple);
}
...
GLM_FUNC_QUALIFIER genIUType prevMultiple(genIUType Source, genIUType Multiple) {
    ...
    return detail::compute_floorMultiple<std::numeric_limits<genIUType>::is_iec559, std::numeric_limits<genIUType>::is_signed>::call(
            Source, Multiple);
}
