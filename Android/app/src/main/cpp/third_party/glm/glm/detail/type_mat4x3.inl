...
mat<4, 3, T, Q>::mat(col_type const &v0, col_type const &v1, col_type const &v2, col_type const &v3)
#		if GLM_HAS_INITIALIZER_LISTS
...
GLM_FUNC_QUALIFIER GLM_CONSTEXPR
mat<4, 3, T, Q>::mat(vec<3, V1, Q> const &v1, vec<3, V2, Q> const &v2, vec<3, V3, Q> const &v3,
                     vec<3, V4, Q> const &v4)
#		if GLM_HAS_INITIALIZER_LISTS
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER typename mat<4, 3, T, Q>::col_type &
mat<4, 3, T, Q>::operator[](typename mat<4, 3, T, Q>::length_type i) {
    assert(i < this->length());
    return this->value[i];
}

template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR typename mat<4, 3, T, Q>::col_type const &
mat<4, 3, T, Q>::operator[](typename mat<4, 3, T, Q>::length_type i) const {
    assert(i < this->length());
    return this->value[i];
}
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER mat<4, 3, T, Q> operator+(mat < 4, 3, T, Q >
const& m) {
return
m;
}
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER mat<2, 3, T, Q> operator*(mat < 4, 3, T, Q >
const& m1,
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER mat<3, 3, T, Q> operator*(mat < 4, 3, T, Q >
const& m1,
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER bool operator==(mat < 4, 3, T, Q >
const& m1,
mat<4, 3, T, Q> const &m2
)
{
