...
return
mat<3, 3, T, Q>(yawPitchRoll(angles.z, angles.x, angles.y));
}
...
template<typename T>
GLM_FUNC_DECL void extractEulerAngleXYZ(mat < 4, 4, T, defaultp >
const& M,
T &t1,
        T
& t2,
...
template<typename T>
GLM_FUNC_QUALIFIER void extractEulerAngleYXZ(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
...
template<typename T>
GLM_FUNC_QUALIFIER void extractEulerAngleXZX(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
...
template<typename T>
GLM_FUNC_QUALIFIER void extractEulerAngleXYX(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
...
template<typename T>
GLM_FUNC_QUALIFIER void extractEulerAngleYXY(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
...
template<typename T>
GLM_FUNC_QUALIFIER void extractEulerAngleYZY(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
...
template<typename T>
GLM_FUNC_QUALIFIER void extractEulerAngleZYZ(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
...
template<typename T>
GLM_FUNC_QUALIFIER void extractEulerAngleZXZ(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
...
template<typename T>
GLM_FUNC_QUALIFIER void extractEulerAngleXZY(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
...
template<typename T>
GLM_FUNC_QUALIFIER void extractEulerAngleYZX(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
...
template<typename T>
GLM_FUNC_QUALIFIER void extractEulerAngleZYX(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
...
template<typename T>
GLM_FUNC_QUALIFIER void extractEulerAngleZXY(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
