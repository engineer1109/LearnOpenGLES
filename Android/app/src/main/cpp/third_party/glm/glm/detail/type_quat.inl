...
qua<T, Q>::operator[](typename qua<T, Q>::length_type i) const {
    assert(i >= 0 && i < this->length());
    return (&x)[i];
}
...
GLM_FUNC_QUALIFIER qua<T, Q>::qua(vec<3, T, Q> const &u, vec<3, T, Q> const &v) {
    ...
    if (real_part < static_cast<T>(1.e-6f) * norm_u_norm_v) {
        ...
        t = abs(u.x) > abs(u.z) ? vec<3, T, Q>(-u.y, u.x, static_cast<T>(0)) : vec<3, T, Q>(
                static_cast<T>(0), -u.z, u.y);
    } else {
...
template<typename U>
GLM_FUNC_QUALIFIER qua<T, Q> &qua<T, Q>::operator+=(qua<U, Q> const &q) {
    return (*this = detail::compute_quat_add<T, Q, detail::is_aligned<Q>::value>::call(*this,
                                                                                       qua<T, Q>(
                                                                                               q)));
}
...
template<typename U>
GLM_FUNC_QUALIFIER qua<T, Q> &qua<T, Q>::operator-=(qua<U, Q> const &q) {
    return (*this = detail::compute_quat_sub<T, Q, detail::is_aligned<Q>::value>::call(*this,
                                                                                       qua<T, Q>(
                                                                                               q)));
}
