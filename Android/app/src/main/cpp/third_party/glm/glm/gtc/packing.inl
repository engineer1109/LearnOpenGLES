...
struct compute_half<3, Q> {
    GLM_FUNC_QUALIFIER static vec<3, uint16, Q> pack(vec<3, float, Q> const &v) {
        vec<3, int16, Q> const Unpack(detail::toFloat16(v.x), detail::toFloat16(v.y),
    ...
    GLM_FUNC_QUALIFIER static vec<3, float, Q> unpack(vec<3, uint16, Q> const &v) {
        i16vec3 Unpack;
        memcpy(&Unpack, &v, sizeof(Unpack));
        return vec<3, float, Q>(detail::toFloat32(v.x), detail::toFloat32(v.y),
...
struct compute_half<4, Q> {
    GLM_FUNC_QUALIFIER static vec<4, uint16, Q> pack(vec<4, float, Q> const &v) {
        vec<4, int16, Q> const Unpack(detail::toFloat16(v.x), detail::toFloat16(v.y),
    ...
    GLM_FUNC_QUALIFIER static vec<4, float, Q> unpack(vec<4, uint16, Q> const &v) {
        i16vec4 Unpack;
        memcpy(&Unpack, &v, sizeof(Unpack));
        return vec<4, float, Q>(detail::toFloat32(v.x), detail::toFloat32(v.y),
                                detail::toFloat32(v.z), detail::toFloat32(v.w));
    }
};
}//namespace detail
...
GLM_FUNC_QUALIFIER uint32 packF3x9_E1x5(vec3 const &v) {
    ...
    float const ExpShared = equal(MaxShared, pow(2.0f, 9.0f), epsilon<float>()) ? ExpSharedP + 1.0f
                                                                                : ExpSharedP;
...
GLM_FUNC_QUALIFIER vec3 unpackF3x9_E1x5(uint32 v) {
    ...
    return vec3(Unpack.data.x, Unpack.data.y, Unpack.data.z) *
...
GLM_FUNC_QUALIFIER vec<4, T, Q> packRGBM(vec<3, T, Q> const &rgb) {
    ...
    T Alpha = clamp(max(max(Color.x, Color.y), max(Color.z, static_cast<T>(1e-6))),
...
GLM_FUNC_QUALIFIER vec<L, uintType, Q> packUnorm(vec<L, floatType, Q> const &v) {
    GLM_STATIC_ASSERT(std::numeric_limits<uintType>::is_integer,
                      "uintType must be an integer type");
    GLM_STATIC_ASSERT(std::numeric_limits<floatType>::is_iec559,
                      "floatType must be a floating point type");

    return vec<L, uintType, Q>(
            round(clamp(v, static_cast<floatType>(0), static_cast<floatType>(1)) *
                  static_cast<floatType>(std::numeric_limits<uintType>::max())));
}
...
GLM_FUNC_QUALIFIER vec<L, floatType, Q> unpackUnorm(vec<L, uintType, Q> const &v) {
    ...
    return vec<L, float, Q>(v) * (static_cast<floatType>(1) /
                                  static_cast<floatType>(std::numeric_limits<uintType>::max()));
}
...
GLM_FUNC_QUALIFIER vec<L, intType, Q> packSnorm(vec<L, floatType, Q> const &v) {
    ...
    return vec<L, intType, Q>(
            round(clamp(v, static_cast<floatType>(-1), static_cast<floatType>(1)) *
                  static_cast<floatType>(std::numeric_limits<intType>::max())));
}
...
GLM_FUNC_QUALIFIER vec<L, floatType, Q> unpackSnorm(vec<L, intType, Q> const &v) {
    ...
    return clamp(vec<L, floatType, Q>(v) * (static_cast<floatType>(1) /
                                            static_cast<floatType>(std::numeric_limits<intType>::max())),
