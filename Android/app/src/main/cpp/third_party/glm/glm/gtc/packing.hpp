...
GLM_FUNC_DECL vec<4, T, Q> packRGBM(vec < 3, T, Q >
const& rgb);
...
/// @see <a href="http://www.opengl.org/registry/doc/GLSLangSpec.4.20.8.pdf">GLSL 4.20.8 specification, section 8.4 Floating-Point Pack and Unpack Functions</a>
template<length_t L, typename T, qualifier Q>
GLM_FUNC_DECL vec<3, T, Q> unpackRGBM(vec < 4, T, Q >
const& rgbm);
...
GLM_FUNC_DECL vec<L, uint16, Q> packHalf(vec < L, float, Q >
const& v);
...
/// @see <a href="http://www.opengl.org/registry/doc/GLSLangSpec.4.20.8.pdf">GLSL 4.20.8 specification, section 8.4 Floating-Point Pack and Unpack Functions</a>
template<length_t L, qualifier Q>
GLM_FUNC_DECL vec<L, float, Q> unpackHalf(vec < L, uint16, Q >
const& p);
...
GLM_FUNC_DECL vec<L, uintType, Q> packUnorm(vec < L, floatType, Q >
const& v);
...
GLM_FUNC_DECL vec<L, floatType, Q> unpackUnorm(vec < L, uintType, Q >
const& v);
...
GLM_FUNC_DECL vec<L, intType, Q> packSnorm(vec < L, floatType, Q >
const& v);
...
GLM_FUNC_DECL vec<L, floatType, Q> unpackSnorm(vec < L, intType, Q >
const& v);
