...
highestBitValue(vec<L, T, Q>
const& v)
{
return
detail::functor1<vec, L, T, T, Q>::call(highestBitValue, v
);
}
...
{
return
detail::functor1<vec, L, T, T, Q>::call(lowestBitValue, v
);
}
...
{
return
detail::functor1<vec, L, T, T, Q>::call(powerOfTwoAbove, v
);
}
...
{
return
detail::functor1<vec, L, T, T, Q>::call(powerOfTwoBelow, v
);
}
...
template<length_t L, typename T, qualifier Q>
GLM_FUNC_QUALIFIER vec<L, T, Q>
powerOfTwoNearest(vec<L, T, Q>
const& v)
{
return
detail::functor1<vec, L, T, T, Q>::call(powerOfTwoNearest, v
);
}
