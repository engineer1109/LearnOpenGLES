...
GLM_FUNC_QUALIFIER void axisAngle(mat < 4, 4, T, Q >
const& m,
vec<3, T, Q> &axis, T
& angle) {
...
+ m[1][2]) < epsilon2) && (
abs(m[0][0]
+ m[1][1] + m[2][2] - static_cast<T>(3.0)) < epsilon2)) {
...
x = static_cast<T>(0.0);
axis.
y = static_cast<T>(0.7071);
axis.
z = static_cast<T>(0.7071);
}
else
{
axis.
...
T s = sqrt((m[2][1] - m[1][2]) * (m[2][1] - m[1][2]) + (m[2][0] - m[0][2]) * (m[2][0] - m[0][2]) +
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER mat<4, 4, T, Q> axisAngleMatrix(vec < 3, T, Q >
const& axis,
T const angle
)
{
...
* n.
z *n
.z + c,          static_cast<T>(0.0),
static_cast<T>(0.0),        static_cast<T>(0.0),        static_cast<T>(0.0),        static_cast<T>(1.0));
}

template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER mat<4, 4, T, Q> extractMatrixRotation(mat < 4, 4, T, Q >
const& m)
{
return
mat<4, 4, T, Q>(
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER mat<4, 4, T, Q> interpolate(mat < 4, 4, T, Q >
const& m1,
