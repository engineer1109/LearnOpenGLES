...
protected:
    GLM_FUNC_QUALIFIER T& elem(size_t
    i){ return (reinterpret_cast<T *>(_buffer))[i]; }
    GLM_FUNC_QUALIFIER T const& elem(size_t
    i) const{ return (reinterpret_cast<const T *>(_buffer))[i]; }
...
struct _swizzle_base1<2, T, Q, E0, E1, -1, -2, Aligned> : public _swizzle_base0<T, 2> {
    ...
    operator()() const { return vec<2, T, Q>(this->elem(E0), this->elem(E1)); }
};
...
struct _swizzle_base1<3, T, Q, E0, E1, E2, -1, Aligned> : public _swizzle_base0<T, 3> {
    ...
    operator()() const { return vec<3, T, Q>(this->elem(E0), this->elem(E1), this->elem(E2)); }
};
...
public:
    GLM_FUNC_QUALIFIER _swizzle_base2
    &
...
struct _swizzle_base2<N, T, Q, E0, E1, E2, E3, 1>
    ...
    operator=(Stub const &) { return *this; }
...
struct _swizzle : public _swizzle_base2<N, T, Q, E0, E1, E2, E3, (E0 == E1 || E0 == E2 ||
                                                                  E0 == E3 || E1 == E2 ||
                                                                  E1 == E3 || E2 == E3)> {
    typedef _swizzle_base2<N, T, Q, E0, E1, E2, E3, (E0 == E1 || E0 == E2 || E0 == E3 || E1 == E2 ||
                                                     E1 == E3 || E2 == E3)> base_type;
