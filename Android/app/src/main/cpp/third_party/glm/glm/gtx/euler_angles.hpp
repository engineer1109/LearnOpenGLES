...
GLM_FUNC_DECL mat<3, 3, T, Q> orientate3(vec < 3, T, Q >
const& angles);

/// Creates a 3D 4 * 4 homogeneous rotation matrix from euler angles (Y * X * Z).
/// @see gtx_euler_angles
template<typename T, qualifier Q>
GLM_FUNC_DECL mat<4, 4, T, Q> orientate4(vec < 3, T, Q >
const& angles);
...
/// @see gtx_euler_angles
template<typename T>
GLM_FUNC_DECL void extractEulerAngleYXZ(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
...
/// @see gtx_euler_angles
template<typename T>
GLM_FUNC_DECL void extractEulerAngleXZX(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
...
/// @see gtx_euler_angles
template<typename T>
GLM_FUNC_DECL void extractEulerAngleXYX(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
...
/// @see gtx_euler_angles
template<typename T>
GLM_FUNC_DECL void extractEulerAngleYXY(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
...
/// @see gtx_euler_angles
template<typename T>
GLM_FUNC_DECL void extractEulerAngleYZY(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
...
/// @see gtx_euler_angles
template<typename T>
GLM_FUNC_DECL void extractEulerAngleZYZ(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
...
/// @see gtx_euler_angles
template<typename T>
GLM_FUNC_DECL void extractEulerAngleZXZ(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
...
/// @see gtx_euler_angles
template<typename T>
GLM_FUNC_DECL void extractEulerAngleXZY(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
...
/// @see gtx_euler_angles
template<typename T>
GLM_FUNC_DECL void extractEulerAngleYZX(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
...
/// @see gtx_euler_angles
template<typename T>
GLM_FUNC_DECL void extractEulerAngleZYX(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
...
/// @see gtx_euler_angles
template<typename T>
GLM_FUNC_DECL void extractEulerAngleZXY(mat < 4, 4, T, defaultp >
const & M,
T &t1,
        T
& t2,
