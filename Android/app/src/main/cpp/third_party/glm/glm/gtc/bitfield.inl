...
return
detail::functor1<vec, L, T, T, Q>::call(mask, v
);
}
...
GLM_FUNC_QUALIFIER uint16
bitfieldInterleave(u8vec2
const& v)
{
return
detail::bitfieldInterleave<uint8, uint16>(v
.x, v.y);
}

GLM_FUNC_QUALIFIER u8vec2
bitfieldDeinterleave(glm::uint16
x)
{
uint16 REG1(x);
uint16 REG2(x >>= 1);
...
GLM_FUNC_QUALIFIER glm::uint32
bitfieldInterleave(u16vec2
const& v)
{
return
detail::bitfieldInterleave<uint16, uint32>(v
.x, v.y);
}

GLM_FUNC_QUALIFIER glm::u16vec2
bitfieldDeinterleave(glm::uint32
x)
{
glm::uint32 REG1(x);
glm::uint32 REG2(x >>= 1);
...
GLM_FUNC_QUALIFIER glm::uint64
bitfieldInterleave(u32vec2
const& v)
{
return
detail::bitfieldInterleave<uint32, uint64>(v
.x, v.y);
}

GLM_FUNC_QUALIFIER glm::u32vec2
bitfieldDeinterleave(glm::uint64
x)
{
glm::uint64 REG1(x);
glm::uint64 REG2(x >>= 1);
...
GLM_FUNC_QUALIFIER uint32
bitfieldInterleave(u8vec3
const& v)
{
return
detail::bitfieldInterleave<uint8, uint32>(v
.x, v.y, v.z);
}
...
GLM_FUNC_QUALIFIER uint64
bitfieldInterleave(u16vec4
const& v)
{
return
detail::bitfieldInterleave<uint16, uint64>(v
.x, v.y, v.z, v.w);
}
}//namespace glm
