...
rgbColor(const vec<3, T, Q> &hsvColor) {
...
hsvColor(const vec<3, T, Q> &rgbColor) {
...
saturation(const T s, const vec<3, T, Q> &color) {
...
saturation(const T s, const vec<4, T, Q> &color) {
...
luminosity(const vec<3, T, Q> &color) {
