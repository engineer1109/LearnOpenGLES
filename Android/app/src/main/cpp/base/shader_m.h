...
public:
    ...
    Shader(const char *vertexPath, const char *fragmentPath, AAssetManager *assetManager) {
        // 1. retrieve the vertex/fragment source code from filePath
//        std::string vertexCode;
//        std::string fragmentCode;

        AAsset *assetVertex = AAssetManager_open(assetManager, vertexPath, AASSET_MODE_STREAMING);
        assert(assetVertex);
