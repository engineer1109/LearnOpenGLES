#ifndef OPENGLES_BASICENGINE_ALGORITHM_H
#define OPENGLES_BASICENGINE_ALGORITHM_H
...
private:
    ...
    T fade(T t) { return t * t * t * (t * (t * (T)6 - (T)15) + (T)10); }
    T lerp(T t, T a, T b) { return a + t * (b - a); }
...
#endif // OPENGLES_BASICENGINE_ALGORITHM_H
